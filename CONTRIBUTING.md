...
Release readiness also covers cross-platform install verification, a licence
audit and the privacy disclosure; see the corresponding workflows in
`.github/workflows/` and [SECURITY.md](SECURITY.md).
