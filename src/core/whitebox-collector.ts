 ...
 *     popup serialization.
 *
 * The popup-tracking approach is adapted from an earlier browser-automation
 * project, re-implemented to fit PixelCheck's fresh-context-per-primitive
 * architecture rather than that project's persistent session model.
 */
