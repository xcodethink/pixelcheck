...
const en = {
  ...
  duration: "Duration",
  fail: "fail",
  generated_by: "Generated by AI Browser Auditor",
  high: "high",
  issues: "Issues",
  ...
  pdf_methodology_intro:
    "The AI Browser Auditor launches real Chromium browser sessions configured with persona-specific device fingerprints and runs scripted user journeys end-to-end. After each run, screenshots and DOM data are scored by Anthropic's Claude vision model against a defined rubric.",
  ...
  trends_empty_state:
    "No audit history found yet. Run `ai-audit run` to seed the trend dashboard.",
  trends_runs_count_one: "1 run",
  trends_runs_count_other: "{n} runs",
  trends_title: "AI Browser Auditor — Trends",
...
const zhCN: Record<keyof typeof en, string> = {
  ...
  trends_empty_state: "尚无审计历史。运行 `ai-audit run` 后再来查看趋势。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  trends_empty_state: "監査履歴がまだありません。`ai-audit run`を実行してから再度ご覧ください。",
...
const es: Record<keyof typeof en, string> = {
  ...
  duration: "Duración",
  fail: "fallo",
  generated_by: "Generado por AI Browser Auditor",
  high: "alto",
  issues: "Incidencias",
  ...
  pdf_methodology_intro:
    "AI Browser Auditor lanza sesiones reales de Chromium con huellas digitales de dispositivo específicas por perfil y ejecuta recorridos de usuario de extremo a extremo. Tras cada ejecución, las capturas y datos del DOM se puntúan con el modelo de visión Claude de Anthropic siguiendo una rúbrica definida.",
  ...
  trends_empty_state: "Aún no hay historial de auditorías. Ejecute `ai-audit run` para alimentar el panel.",
...
const de: Record<keyof typeof en, string> = {
  ...
  trends_empty_state: "Noch kein Audit-Verlauf. Führen Sie `ai-audit run` aus, um das Trend-Dashboard zu befüllen.",
