...
of the same author's projects. Until the v1.0-rc1 dogfood run (2026-05-02) it
lived as a sibling git repository and was wired into this package via:
...
- Switching to a monorepo would touch all 5 projects + restructure
  a shared local layout — out of scope for v1.0
