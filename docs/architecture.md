...
- **primitive** — single-capability building blocks. Today: `see` (N-1 — see [ADR-011](decisions/ADR-011-see-primitive.md)), `act` (N-2 — see [ADR-012](decisions/ADR-012-act-primitive.md)), and `extract` (N-4 — see [ADR-013](decisions/ADR-013-extract-primitive.md)). Coming: N-3 `compare`.
